...
import {
    Avatar,
    Box, Button, Card, CardActions, CardContent, CardHeader, CircularProgress,
...
const UserProfile = (props) => {
    ...
    const [userDetailState, dispatch] = useReducer(userDetailReducer,initialUserDetailInfor);
    ...
    return    (
        ...
        {loading ?   <CircularProgress /> :  <div className={cs(classnames.hb_user_profile)}>
                <Helmet>
