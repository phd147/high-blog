...
import {BASE_URL, NOTIFICATION_WEBSOCKET_CONNECT_URL} from "../../constant";
import {removeToken} from "../../services/user.service";
import NotificationMenuList from "../Notification/NotificationMenuList";
import WebsocketConfig from "../Notification/WebsocketConfig";
                                ...
                                {userId ? (
                                    <div>
                                        ...
                                        <Popover
                                            ...
                                            style={{paddingLeft: 0}}
                                        >
                                            <NotificationMenuList style onItemClick={handleNotificationClose}/>
                                        </Popover>
                                    </div>
                                ) : null}
                                {!userId ? (
...
export default React.memo(HBHeader);